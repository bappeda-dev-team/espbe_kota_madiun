...
function FormLayanan() {
  ...
  const prosesBisnis = async (formData: any) => {
    ...
    const dataProsesBisnis = {
      ...
      rab_level_4_id: formData.rab_level_4_id
        ? parseInt(formData.rab_level_4_id, 10)
        : null,
      rab_level_5_id: formData.rab_level_5_id
        ? parseInt(formData.rab_level_5_id, 10)
        : null,
      rab_level_6_id: formData.rab_level_6_id
        ? parseInt(formData.rab_level_6_id, 10)
        : null,
    ...
    try {
      ...
      alert(
        "gagal menyimpan data, silakan cek koneksi internet/database server",
      );
    }
  };
    ...
    <>
      <div className="border p-5">
        ...
        <form
          ...
          onSubmit={handleSubmit(prosesBisnis)}
        >
          <div className="flex flex-col py-3">
            ...
            {errors.nama_proses_bisnis && (
              <>
                <h1 className="text-red-500">proses bisnis harus terisi</h1>
              </>
            )}
          </div>
          <div className="flex flex-col py-3">
            ...
            {errors.sasaran_kota && (
              <>
                <h1 className="text-red-500">sasaran kota harus terisi</h1>
              </>
            )}
          </div>
          <div className="flex flex-col py-3">
            ...
            />
            {errors.bidang_urusan && (
              <>
                <h1 className="text-red-500">bidang urusan harus terisi</h1>
              </>
            )}
          </div>
          <div className="flex flex-col py-3">
            ...
            {errors.kode_opd && (
              <>
                <h1 className="text-red-500">kode OPD harus terisi</h1>
              </>
            )}
          </div>
          <div className="flex flex-col py-3">
            ...
            {errors.kode_proses_bisnis && (
              <>
                <h1 className="text-red-500">
                  kode proses bisnis harus terisi
                </h1>
              </>
            )}
          </div>
          <div className="flex flex-col py-3">
            ...
            {errors.tahun && (
              <>
                <h1 className="text-red-500">tahun harus terisi</h1>
              </>
            )}
          </div>
          <div className="flex flex-col py-3">
            ...
            {errors.rab_level_1_id && (
              <>
                <h1 className="text-red-500">rab Level 1 Harus terisi</h1>
              </>
            )}
          </div>
          <div className="flex flex-col py-3">
            ...
            {errors.rab_level_2_id && (
              <>
                <h1 className="text-red-500">rab Level 2 Harus terisi</h1>
              </>
            )}
          </div>
          <div className="flex flex-col py-3">
            ...
            {errors.rab_level_3_id && (
              <>
                <h1 className="text-red-500">rab Level 3 Harus terisi</h1>
              </>
            )}
          </div>
          <div className="flex flex-col py-3">
