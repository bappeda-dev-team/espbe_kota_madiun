      ...
      <div className="flex">
        <h1 className="uppercase font-bold">
          ...
          {user?.roles == 'admin_kota' 
            ? `${SelectedOpd?.label == (undefined || null) ? "" : SelectedOpd?.label} ${tahun?.value == (undefined || null) ? "" : tahun?.label}`
            : `${opd.length > 0 ? opd[0].nama_opd : ''} ${tahun == (0 || undefined || null) ? "Semua Tahun" : tahun?.label}`
          }
        </h1>
      </div>
      </div>
