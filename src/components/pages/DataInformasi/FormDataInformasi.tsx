        ...
        <>
            ...
            <form action="#" className="flex flex-col mx-5 py-5">
                <div className="flex flex-col py-3">
                    <label className="uppercase text-xs font-bold text-gray-700 my-2" htmlFor="Nama data">Nama Data</label>
                    <input className="border px-4 py-2" id="Nama Data" name="Nama Data" type="text" placeholder="Masukkan Nama Data" /> 
                </div>
                <div className="flex flex-col py-3">
                    <label className="uppercase text-xs font-bold text-gray-700 my-2" htmlFor="Sifat Data">Sifat Data</label>
                    <select className="border px-4 py-2" name="Sifat Data" id="Sifat Data" defaultValue={1}>
                        <option hidden value="1">Pilih Sifat Data</option>
                        <option value="option 1">Terbatas</option>
                        <option value="option 2">Terbuka</option>
                        <option value="option 3">Tertutup</option>
                    </select>
                </div>
                <div className="flex flex-col py-3">
